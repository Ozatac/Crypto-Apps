package com.tunahanozatac.cryptoapps.infrastructure.notification
...
import com.tunahanozatac.cryptoapps.util.Constants.CHANNEL_ID
import com.tunahanozatac.cryptoapps.util.Constants.CHANNEL_NAME
...
object NotificationUtils {
    ...
    private fun createNotificationCompat(
        ...
        return NotificationCompat.Builder(context, CHANNEL_ID).setContentTitle(title)
            .setContentText(description).setSmallIcon(R.mipmap.ic_launcher)
