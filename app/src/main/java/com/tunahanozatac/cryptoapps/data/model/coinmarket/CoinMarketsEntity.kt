package com.tunahanozatac.cryptoapps.data.model.coinmarket
...
data class CoinMarketsEntity(
    ...
    @ColumnInfo(name = "priceType") val athChangePercentage: Double?,
    @ColumnInfo(name = "date") val athDate: String?,
    @ColumnInfo(name = "atl") val atl: Double?,
    @ColumnInfo(name = "atlChangePercentage") val atlChangePercentage: Double?,
    @ColumnInfo(name = "atlDate") val atlDate: String?,
    @ColumnInfo(name = "circulatingSupply") val circulatingSupply: Double?,
    @ColumnInfo(name = "currentPrice") val currentPrice: Double?,
    @ColumnInfo(name = "fullyDilutedValuation") val fullyDilutedValuation: Long?,
