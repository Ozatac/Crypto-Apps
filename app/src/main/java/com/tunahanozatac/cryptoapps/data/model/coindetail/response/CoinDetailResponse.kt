package com.tunahanozatac.cryptoapps.data.model.coindetail.response

import com.google.gson.annotations.SerializedName

data class CoinDetailResponse(
    @SerializedName("additional_notices") val additionalNotices: List<Any>?,
    @SerializedName("asset_platform_id") val assetPlatformId: Any?,
    ...
    @SerializedName("public_interest_stats") val publicInterestStats: PublicInterestStats?,
    @SerializedName("public_notice") val publicNotice: Any?,
    ...
    @SerializedName("status_updates") val statusUpdates: List<Any>?,
